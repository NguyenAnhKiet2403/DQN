...
class FlappyBirdRewardShaping(gym.Wrapper):
    ...
    def step(self, action):
        ...
        if reward >= 1.0:  # Vượt ống
            shaped_reward += 15.0  # Tăng từ 1. 0 → 15.0
            self. last_score += 1
